    ...
    measurements: [
      ...
      },
      {
        ...
        normalValues: [
          ...
          { label: '15 mm threshold', value: 'Supraspinatus stump < 15 mm with Goutallier 2–3 → 92% repair failure rate; stump > 15 mm → 33% failure rate' },
        ],
        citations: [
          { label: 'Meyer DC, Wieser K, Farshad M, Gerber C. — Retraction of supraspinatus muscle and tendon as predictors of success of rotator cuff repair. Am J Sports Med 2012;40(10):2242-2247.', url: 'https://scholar.google.com/scholar?q=Meyer+Wieser+Farshad+Gerber+retraction+supraspinatus+muscle+tendon+predictors+success+rotator+cuff+repair+2012' },
        ],
        diagram: null,
      },
      {
      ...
      {
        id: 'labral-injuries',
        label: 'Labral Injuries',
        isGradingScale: true,
        plane: 'Axial + ABER',
        description: 'Spectrum of glenoid labral injury patterns on MRI/MR arthrography, including Bankart and SLAP lesion variants.',
        normalValues: [
          { label: 'Bankart lesion', value: 'Anteroinferior labral tear, often with avulsion of the anterior band of the IGHL' },
          { label: 'Bony Bankart', value: 'Bankart lesion with associated anteroinferior glenoid rim fracture' },
          { label: 'Perthes lesion', value: 'Labrum stripped from the glenoid but periosteum remains intact, displaced medially' },
          { label: 'ALPSA lesion', value: 'Anterior labroligamentous periosteal sleeve avulsion — labrum displaced medially and inferiorly, healed in medialized position' },
          { label: 'GLAD lesion', value: 'Glenolabral articular disruption — superficial anteroinferior labral tear with adjacent glenoid cartilage injury, capsulolabral complex intact' },
          { label: 'SLAP lesion', value: 'Superior labrum anterior-to-posterior tear, classically Type I–IV (Snyder), with multiple described subtypes' },
          { label: 'Posterior (reverse Bankart)', value: 'Posteroinferior labral tear, associated with posterior instability' },
          { label: 'POLPSA lesion', value: 'Posterior labroligamentous periosteal sleeve avulsion — posterior analog of ALPSA' },
        ],
        citations: [
          { label: 'Waldt S et al. — Diagnostic performance of MR arthrography in the assessment of superior labral anteroposterior lesions of the shoulder. AJR 2004.', url: 'https://scholar.google.com/scholar?q=Waldt+MR+arthrography+superior+labral+anteroposterior+lesions+shoulder+2004' },
          { label: 'Bencardino JT et al. — Superior labrum anterior-posterior lesions: diagnosis with MR arthrography. Radiographics 2000.', url: 'https://scholar.google.com/scholar?q=Bencardino+superior+labrum+anterior+posterior+lesions+SLAP+MR+arthrography+2000' },
        ],
        diagram: null,
        singleImage: '/images/msk/labral_injuries.jpg',
      },
      {
  ...
  hip: {
    ...
    measurements: [
      ...
      },
      {
        ...
        diagram: null,
        singleImage: '/images/msk/lateral_cea.jpg',
      },
      {
    ...
    measurements: [
      {
        ...
        diagram: null,
        singleImage: '/images/msk/ecu.jpg',
      },
      {
        id: 'tfcc-palmer',
      ...
      },
      {
        ...
        diagram: null,
        singleImage: '/images/msk/kienboch.jpg',
      },
      {
        id: 'mayfield',
        label: 'Mayfield Classification (Perilunate Instability)',
        isGradingScale: true,
        plane: 'Coronal + Sagittal',
        description: 'Describes the progressive stages of perilunate instability following a fall on an outstretched hand, as ligamentous (or osseoligamentous) disruption progresses around the lunate ("lesser arc") or through adjacent carpal bones ("greater arc").',
        normalValues: [
          { label: 'Stage I', value: 'Scapholunate dissociation/dislocation — SL ligament disrupted (SL gap > 3 mm, Terry Thomas sign), ± scaphoid fracture (greater arc)' },
          { label: 'Stage II', value: 'Stage I + lunocapitate dissociation — capitate disrupts from the lunate' },
          { label: 'Stage III', value: 'Stage II + lunotriquetral dissociation — completes perilunate dislocation (lunate remains aligned with radius; rest of carpus dislocates dorsally)' },
          { label: 'Stage IV', value: 'Lunate dislocates volarly out of the radial fossa (true lunate dislocation) — "spilled teacup" sign; median nerve compression risk' },
          { label: 'Greater arc variant', value: 'Trans-scaphoid (± trans-capitate, trans-triquetral, trans-radial styloid) perilunate fracture-dislocation' },
        ],
        citations: [
          { label: 'Mayfield JK et al. — Carpal dislocations: pathomechanics and progressive perilunar instability. J Hand Surg Am 1980;5(3):226-241.', url: 'https://scholar.google.com/scholar?q=Mayfield+carpal+dislocations+pathomechanics+progressive+perilunar+instability+1980' },
        ],
        diagram: null,
      },
      {
  ...
  ankle: {
    ...
    measurements: [
      ...
      },
      {
        ...
        label: 'Ankle Fracture Classification — Weber / Lauge-Hansen',
        isGradingScale: true,
        plane: 'Coronal + Axial',
        description: 'Two complementary systems for ankle fractures. Weber (Danis-Weber) classifies by the level of the fibular fracture relative to the syndesmosis — simple and reproducible, but purely anatomic. Lauge-Hansen is mechanism-based and predicts the sequence of ligamentous and osseous injury, which is especially useful for correlating MRI findings of ligament/syndesmosis disruption with the fracture pattern.',
        diagram: null,
        citations: [
          ...
          { label: 'Lauge-Hansen N. — Fractures of the ankle II: combined experimental-surgical and experimental-roentgenologic investigations. Arch Surg 1950;60(5):957-985.', url: 'https://scholar.google.com/scholar?q=Lauge-Hansen%20ankle%20fractures%20classification%20Arch%20Surg%201950' },
        ],
        normalValues: [
          { label: '── WEBER (fibular fracture level) ──', value: '' },
          { label: 'Weber A (infrasyndesmal)', value: 'Fibula fracture below the syndesmosis; ATFL disruption; syndesmosis intact; usually stable' },
          { label: 'Weber B (transyndesmal)', value: 'Fibula fracture at the level of the syndesmosis (most common); oblique/spiral; syndesmosis ± disrupted; stability variable' },
          { label: 'Weber C (suprasyndesmal)', value: 'Fibula fracture above the syndesmosis; syndesmosis disrupted; medial-sided injury required for instability; a high fibular fracture is a Maisonneuve variant' },
          { label: '── LAUGE-HANSEN (mechanism-based stages) ──', value: '' },
          { label: 'Supination-Adduction (SA)', value: 'Stage 1: transverse fibular avulsion below the joint line, or ATFL/CFL tear; Stage 2: vertical medial malleolus fracture (≈ Weber A pattern)' },
          { label: 'Supination-External Rotation (SER)', value: 'Most common (~40–75%). Stage 1: AITFL tear/avulsion; Stage 2: short oblique/spiral distal fibula fracture (typical Weber B); Stage 3: posterior malleolus fracture or PITFL tear; Stage 4: medial malleolus fracture or deltoid ligament tear' },
          { label: 'Pronation-Abduction (PA)', value: 'Stage 1: deltoid ligament tear or transverse medial malleolus fracture; Stage 2: syndesmosis injury (AITFL ± PITFL); Stage 3: short oblique/comminuted fibula fracture ABOVE the syndesmosis with a lateral bending wedge' },
          { label: 'Pronation-External Rotation (PER)', value: 'Stage 1: deltoid ligament tear or medial malleolus fracture; Stage 2: AITFL tear; Stage 3: high spiral fibula fracture ABOVE the syndesmosis (Weber C pattern); Stage 4: PITFL tear or posterior malleolus fracture — the Maisonneuve fracture is a PER variant with a very proximal fibular fracture' },
          { label: '⚠ Maisonneuve', value: 'Weber C / PER pattern + proximal fibular fracture; image the full fibula on both MRI and X-ray/CT' },
        ],
      },
      {
        id: 'oden-spr',
        label: 'Oden Classification (SPR Injuries — Peroneal Tendon Subluxation)',
        isGradingScale: true,
        plane: 'Axial',
        description: 'Classifies injuries to the superior peroneal retinaculum (SPR), the key restraint preventing peroneal tendon subluxation/dislocation from the retromalleolar groove.',
        diagram: null,
        normalValues: [
          { label: 'Type I (most common, ~51%)', value: 'SPR stripped from the fibula along with the periosteum, creating an elevated pocket lateral to the fibula into which the peroneal tendons sublux' },
          { label: 'Type II', value: 'SPR torn from the fibrocartilaginous ridge along the posterolateral fibular rim — the ridge is avulsed along with the retinaculum' },
          { label: 'Type III', value: 'A thin osteocartilaginous (rim) fragment of the posterolateral fibular cortex is avulsed together with the SPR' },
          { label: 'Type IV', value: 'SPR torn from its posterior attachment (to the Achilles tendon sheath/deep crural fascia), allowing the peroneal tendons to dislocate posteriorly' },
        ],
        citations: [
          { label: 'Oden RR. — Tendon injuries about the ankle resulting from skiing. Clin Orthop Relat Res 1987;(216):63-69.', url: 'https://scholar.google.com/scholar?q=Oden+tendon+injuries+ankle+skiing+superior+peroneal+retinaculum+classification+1987' },
        ],
      },
      {
        id: 'atfl-thickness',
