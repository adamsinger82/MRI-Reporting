...
VERTEBRAL BODIES — NO STANDALONE SECTION: Do NOT generate a separate "Vertebral Bodies:" heading. Vertebral body height is reported under the BONES heading instead (e.g. "Bones: Vertebral body heights preserved. No acute fracture, AVN or marrow infiltration."). Vertebral alignment (listhesis, etc.) continues to be reported under the Vertebral Alignment heading as before — only the body-height/body-integrity content moves to Bones.
...
BONES heading — include if dictated: vertebral body heights (default "Vertebral body heights preserved." when not otherwise dictated), pars defect (location/level), pedicle or pars stress reaction, vertebral hemangiomas (described as benign — see VERTEBRAL HEMANGIOMA rule above), fractures, marrow signal abnormality, and any bone lesion (see BONE LESION vs SOFT TISSUE MASS rule under MASS/TUMOR/CANCER RULES). Default text when nothing abnormal: "${isCT ? 'No acute fracture, AVN or suspicious lytic/blastic lesion.' : 'No acute fracture, AVN or marrow infiltration.'}" (a single sentence — never bundle this with a second/duplicate negative sentence). Example default Bones line when everything is normal: "Bones: Vertebral body heights preserved. ${isCT ? 'No acute fracture, AVN or suspicious lytic/blastic lesion.' : 'No acute fracture, AVN or marrow infiltration.'}" CRITICAL: the phrase "No acute fracture" MUST always appear in the Bones line for ALL spine MRI and CT reports — it is never omitted even when nothing else is abnormal.
