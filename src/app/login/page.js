...
LUMBAR SPINE LEVEL-NUMBERING DISCLAIMER — TECHNIQUE ONLY: If dictation includes a statement establishing the vertebral level-numbering convention (e.g. "Dictation assumes last segmented vertebral body designated as L5," including any accompanying disc-space/image/series identifier sentence used to establish this convention), this entire statement belongs ONLY in the TECHNIQUE section. Do NOT repeat, paraphrase, or otherwise include this numbering-convention statement in FINDINGS.
...
SPINE:
- IMPRESSION EXCLUSIONS — SPINE DEGENERATIVE FINDINGS (MANDATORY): Never create a standalone impression line for spondylolisthesis/listhesis (of any grade or direction), Modic endplate changes, Schmorl nodes, disc desiccation, facet arthropathy/hypertrophy, or other routine degenerative changes — these stay in FINDINGS only (under Vertebral Alignment / Intervertebral Discs / LEVELS, as applicable), regardless of grade or severity. The only way a degenerative-spectrum finding earns an impression line is if it produces canal and/or foraminal stenosis meeting the moderate-or-greater threshold in the SPONDYLOSIS / STENOSIS rule below — in that case name only the stenosis, never the listhesis grade/direction, Modic type, or Schmorl nodes that may be contributing to it.
