    ...
    measurements: [
      ...
      },
      {
        ...
        normalValues: [
          ...
          { label: 'Grade 3', value: 'Displaced/fluid-distended gap at the meniscocapsular junction — frank unstable tear' },
        ],
      },
    ],
  },
  spine: {
    ...
    measurements: [
      ...
      },
      {
        ...
        plane: 'Axial T2',
        description: 'Kim grading of cervical neural foraminal stenosis on axial T2 MRI. Compares narrowest foramen width to extraforaminal nerve root width at the anterior margin of the superior articular process.',
        ...
        normalValues: [
          { label: '── KIM SYSTEM (Axial T2) ──', value: '' },
          { label: 'Grade 0 (Normal)', value: 'Narrowest foramen width > width of extraforaminal nerve root at anterior margin of superior articular process.' },
          { label: 'Grade 1 (Non-severe)', value: 'Narrowest foramen width is 51–100% of extraforaminal nerve root width.' },
          { label: 'Grade 2 (Severe)', value: 'Narrowest foramen width ≤ 50% of extraforaminal nerve root width.' },
          { label: '── PARK SYSTEM (reference) ──', value: '' },
          { label: 'Park — oblique sagittal', value: 'Cervical alternative using oblique sagittal plane aligned to foramen. Grade 0–3 on fat/root criteria. See citation.' },
          { label: 'Clinical note', value: 'Grade 2 correlates with radiculopathy. Report level and side.' },
        ],
      },
      {
  ...
  wrist: {
    ...
    measurements: [
      ...
      },
      {
        ...
        isGradingScale: true,
        plane: 'Sagittal + Coronal',
        description: 'Progressive perilunate instability (Mayfield stages I–IV) following a fall on an outstretched hand. Greater arc injuries involve fractures through carpal bones; lesser arc = pure ligamentous. CT essential for identifying carpal fractures and assessing reduction.',
        diagram: null,
        citations: [
        ...
        normalValues: [
          { label: 'Stage I', value: 'Scapholunate dissociation/dislocation (SL gap > 3 mm, Terry Thomas sign), ± scaphoid fracture (greater arc)' },
          { label: 'Stage II', value: 'Stage I + lunocapitate dissociation' },
          { label: 'Stage III', value: 'Stage II + lunotriquetral dissociation = perilunate dislocation' },
          ...
          { label: 'Greater arc (trans-scaphoid)', value: 'Fracture through scaphoid ± capitate ± hamate ± triquetrum — trans-scaphoid perilunate fracture-dislocation most common variant' },
        ],
      },
      {
        id: 'carpal-instability-classification-ct',
        ...
        normalValues: [
          { label: 'CID — Dissociative', value: 'Disruption of an interosseous ligament within a carpal row (SL or LT) — produces DISI (SL tear, SL angle > 70°) or VISI (LT tear, lunocapitate < -15°) patterns' },
      ...
      },
      {
        ...
        isGradingScale: true,
        plane: 'Coronal',
        description: 'Staging of avascular necrosis of the lunate (Kienböck disease). CT demonstrates lunate sclerosis, collapse, and fixed scaphoid rotation better than radiographs; MRI remains the only modality detecting Stage I.',
        diagram: null,
        ...
        normalValues: [
          { label: 'Stage I', value: 'Normal radiographs/CT; MRI shows diffuse marrow signal change — detectable only by MRI' },
          { label: 'Stage II', value: 'Sclerosis of the lunate without collapse; normal lunate shape and carpal alignment' },
    ...
    measurements: [
      {
        ...
        normalValues: [
          ...
          { label: '── LAUGE-HANSEN (mechanism-based) ──', value: '' },
          { label: 'Supination-Adduction (SA)', value: 'Stage 1: transverse fibular avulsion fracture below the joint line or ATFL/CFL tear; Stage 2: vertical medial malleolus fracture (≈ Weber A pattern)' },
          ...
          { label: 'Pronation-Abduction (PA)', value: 'Stage 1: deltoid ligament tear or transverse medial malleolus fracture; Stage 2: syndesmosis injury (AITFL ± PITFL); Stage 3: short oblique/comminuted fibula fracture ABOVE the syndesmosis with lateral bending wedge' },
          ...
          { label: '⚠ Maisonneuve', value: 'Weber C / PER pattern + proximal fibular fracture; image full fibula; CT ankle + CT/X-ray proximal fibula' },
        ],
      },
      {
